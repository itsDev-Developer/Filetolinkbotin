...
‣ ɢᴇᴛ <a href="https://t.me/Helper_24x7">ᴍᴏʀᴇ ғɪʟᴇs</a></b> 🤡"""
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Support [Support](https://t.me/Uchiha_Developer) They Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_photo(
                chat_id=m.chat.id,
                photo="https://assets-prd.ignimgs.com/2022/09/30/best-magical-girl-anime-thumb-1664575012045.jpg",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ Support** [Support](https://t.me/Uchiha_Developer)",
